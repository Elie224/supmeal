...
class Settings(BaseSettings):
    ...
    google_redirect_uri: str = "http://localhost:8765/api/v1/auth/oauth/google/callback"

    # OAuth2 - GitHub
    github_client_id: str = ""
    github_client_secret: str = ""
    github_redirect_uri: str = "http://localhost:8765/api/v1/auth/oauth/github/callback"
