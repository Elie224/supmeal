...
Un cookbook vous permet de partager un ensemble de recettes avec d autres utilisateurs, de discuter ensemble et de planifier des repas en commun.

## Creer un cookbook

1. Allez dans **Mes cookbooks** (barre laterale).
2. Cliquez sur **Creer un cookbook**.
3. Donnez un nom et une description.
4. Validez : vous etes automatiquement **createur** du cookbook.

## Inviter des membres

En tant que createur, sur l onglet **Membres** d un cookbook :
...
| Action | Lecteur | Commentateur | Editeur | Createur |
|--------|---------|--------------|---------|----------|
...
Dans un cookbook, chaque recette dispose d un espace commentaire. Tous les membres (sauf lecteurs) peuvent laisser un avis, une suggestion ou une variante.